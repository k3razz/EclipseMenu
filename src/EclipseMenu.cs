...
public partial class EclipseMenu : BasePlugin
{
    public Harmony Harmony { get; } = new(Id);
    public static EclipseMenu Plugin;
    ...
    public static string EclipseVersion = "1.5.0";
    ...
    public override void Load()
    {
        ...
        menuKeybind = Config.Bind("EclipseMenu.GUI",
                                "Keybind",
                                "Delete",
        ...
        menuHtmlColor = Config.Bind("EclipseMenu.GUI",
                                "Color",
                                "",
                                "A custom color for your EclipseMenu GUI. Supports html color codes");

        menuOpenOnMouse = Config.Bind("EclipseMenu.GUI",
                                "OpenOnMouse",
                                false,
                                "When enabled, the EclipseMenu GUI will always be opened at the current mouse position");

        menuKeepSubwindowsOpen = Config.Bind("EclipseMenu.GUI",
                                "KeepSubwindowsOpen",
                                false,
                                "When enabled, closing the EclipseMenu GUI will not automatically close its subwindows");

        autoLoadProfile = Config.Bind("EclipseMenu.Profile",
                                "AutoLoadProfile",
                                false,
                                "When enabled, your saved keybind and toggle profile will be automatically loaded at game startup");

        configEditor = Config.Bind("EclipseMenu.Config",
                                "ConfigEditor",
                                "notepad.exe",
        ...
        // guestMode = Config.Bind("EclipseMenu.GuestMode",
        //                         "GuestMode",
        //                         false,
        ...
        // guestFriendCode = Config.Bind("EclipseMenu.GuestMode",
        //                         "FriendName",
        //                         "",
        ...
        spoofLevel = Config.Bind("EclipseMenu.Spoofing",
                                "Level",
                                "",
        ...
        spoofPlatform = Config.Bind("EclipseMenu.Spoofing",
                                "Platform",
                                "",
        ...
        spoofDeviceId = Config.Bind("EclipseMenu.Privacy",
                                "HideDeviceId",
                                true,
        ...
        noTelemetry = Config.Bind("EclipseMenu.Privacy",
                                "NoTelemetry",
                                true,
        ...
        adaptMaxStrength = Config.Bind("EclipseMenu.Overload",
                                "AdaptMaxStrength",
                                500,
...
/*        adaptMaxCooldown = Config.Bind("EclipseMenu.Overload",
        ...
        attackLogDelay = Config.Bind("EclipseMenu.Overload",
                                "AttackLogDelay",
                                2f,
                                "Minimum time (in seconds) between attack logs in normal (non-verbose) mode");

        defaultStrength = Config.Bind("EclipseMenu.Overload",
                                "DefaultStrength",
                                500,
                                new ConfigDescription(
        ...
        defaultCooldown = Config.Bind("EclipseMenu.Overload",
                                "DefaultCooldown",
                                1f,
                                new ConfigDescription(
        ...
        killSwitchLvl = Config.Bind("EclipseMenu.Overload",
...
*/      // Enabled by default
        ...
        SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>) ((scene, _) =>
        {
            if (scene.name == "MainMenu" && !(inStealthMode || isPanicked))
            {
                ...
                {
                    Utils.ShowPopup("\nThis version of EclipseMenu and this version of Among Us are incompatible\n\nInstall the right version to avoid problems");
                }
            }
        }));
    }
